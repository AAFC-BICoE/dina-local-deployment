...
:var_ubuntu_version: 22.04
:var_docker_version: 29.1.5
:var_docker_compose_version: 5.0.1
:var_nvm_version: 0.40.2
:var_node_version: 22
:var_yarn_version: 1.22.21
:var_maven_version: 3.9.8

[cols="2,1", subs="attributes"]
|===
| Component | Tested version

| Linux | Ubuntu {var_ubuntu_version}
| Docker | {var_docker_version}
| Docker Compose CLI plugin | v{var_docker_compose_version}
| Node.js (via nvm) | {var_node_version}
| nvm | v{var_nvm_version}
| Yarn (Corepack-managed) | {var_yarn_version}
| Maven | {var_maven_version}
|===
...
Using this command, you will retrieve the specific package of Docker (version {var_docker_version}) for your Ubuntu version:

[source, bash, subs="attributes"]
----
sudo apt-cache policy docker-ce | grep {var_docker_version}
----
...
Follow Post-installation steps to Manage Docker as a non-root user https://docs.docker.com/engine/install/linux-postinstall/
...
[source, bash, subs="attributes"]
----
curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v{var_nvm_version}/install.sh | bash
----

More info: https://github.com/nvm-sh/nvm#installing-and-updating

Install node {var_node_version}

[source, bash, subs="attributes"]
----
nvm install {var_node_version}
nvm use {var_node_version}
----
...
----
corepack enable
yarn set version {var_yarn_version}
----
...
=== VSCode Launch Configurations (Optional)
