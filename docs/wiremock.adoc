...
The mock API stubs are located in https://github.com/AAFC-BICoE/dina-local-deployment/tree/master/wiremock/mappings[dina-local-deployment/wiremock/mappings].
