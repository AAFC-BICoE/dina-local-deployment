...
-- in the keycloak_db database of the keycloak-db container.
--
-- NOTE: The target schema below is hardcoded to 'keycloak'. If you changed KEYCLOAK_DB_SCHEMA in your
-- .env file, update target_schema below to match that value before running this script.
DO $$
DECLARE
